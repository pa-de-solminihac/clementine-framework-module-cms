...
<form action="<?php echo __WWW__; ?>/cms/zoneparams?id_zone=<?php echo $data['id_zone']; ?>&amp;id_page=<?php echo $data['id_page']; ?>" method="post" accept-charset="<?php echo __HTML_ENCODING__; ?>">

<input name="id_zone" type="hidden" value="<?php echo $data['id_zone']; ?>" />
<input name="id_page" type="hidden" value="<?php echo $data['id_page']; ?>" />
<table class="clementine_cms_zone_params">
<tbody>
<?php
...
<tr><td>
    ...
    <img class="clementine_cms_zone_del_param_button" src="<?php echo __WWW_ROOT_CMS__; ?>/skin/images/delete.png" />
</td></tr>
<?php
    ++$i;
}
...
<img class="clementine_cms_zone_add_param_button" src="<?php echo __WWW_ROOT_CMS__; ?>/skin/images/add.png" alt="ajouter un nouveau parametre"/>
<div class="clementine_cms_zoneparams_submit">
...
<script type="text/javascript" charset="<?php echo __HTML_ENCODING__; ?>">
    if (typeof jQuery != 'undefined') {
        ...
        jQuery('.clementine_cms_zone_add_param_button').click(function() {
            var numero = jQuery('.clementine_cms_zone_params .clementine_cms_zone_new_param').length;
            jQuery('.clementine_cms_zone_params tbody').append(' <tr class="clementine_cms_zone_new_param"><td> <input name="new_param_name_' + numero + '" type="text" value="" /> </td><td> <input name="new_param_val_' + numero  + '" type="text" value="" /> </td><td> <img class="clementine_cms_zone_del_param_button" src="<?php echo __WWW_ROOT_CMS__; ?>/skin/images/delete.png" /> </td></tr> ');
